...
Добавление элементов в начало и конец связного списка, как и массива является последовательным, но в отличии от массива совершается за константное время. Получение прямого доступа возможно только к первому и последнему узлу, а так же к следуйщему и предыдущему относительно текущего узла. Во всех остальных случаях такая операция осуществляется за n времени  
