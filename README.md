...
Приемущества списка связного перед массивом в том, что добавление элементов в начало и конец, как и у массива является последовательным, но в отличии от массива - удаление первого элемента происходит за константное время  

Получение прямого доступа за константное время возможно только к первому и последнему узлу, а так же к следуйщему и предыдущему узлу относительно текущего. Во всех остальных случаях такая операция осуществляется за n времени  
